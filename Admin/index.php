...
if (isset($_POST['submit'])) {
    ...
    if ($count > 0) {
        $session_email = $_SESSION['email'] = $row['email'];
                                ...
                                <div class="card-body">
                                    <form method="POST">
                                        ...
                                        <div
                                            ...
                                            <button name="submit" class="btn btn-primary">Admin Login</button>
                                        </div>
                                    </form>
                                </div>
            ...
            <footer class="py-4 bg-light mt-auto">
                <div class="container-fluid">
                    <div class="d-flex align-items-center justify-content-between small">
                        <div class="text-muted">Copyright &copy; HTML Template 2020</div>
                    </div>
                </div>
            </footer>
        </div>
